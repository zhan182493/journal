<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:64:"F:\journal\public/../application/index\view\artlist\artlist.html";i:1578453340;s:50:"F:\journal\application\index\view\public\head.html";i:1578463323;s:51:"F:\journal\application\index\view\public\right.html";i:1578467531;s:50:"F:\journal\application\index\view\public\foot.html";i:1578449367;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div class="container">
	...
	<!-- 左边 -->
		<div class="left-sidebar col-md-8" style="padding-right: 20px;">
			<h4 class="item_title"><?php echo $title; ?></h4>
	...
	<div class=noselectrow>
		<div class="wenzhang">
			<dl>							
				<div class="artlist">
				<dd>
					<a target="_blank" href="#" class="biaoti">关于全国两会期间期刊网站访问受限的公告</a>
					<span class="time">[2020-01-08]</span>
				</dd>
				<dd>
					<a target="_blank" href="#" class="biaoti">李良玉教授受聘为我刊特邀编委并做专题讲座</a>
					<span class="time">[2020-01-08]</span>
				</dd>
				<dd>
					<a target="_blank" href="#" class="biaoti">杂志社赴南京大学中国社会科学研究评价中心调研学习</a>
					<span class="time">[2020-01-08]</span>
				</dd>
				<dd>
					<a target="_blank" href="#" class="biaoti">2017年高被引论文、优秀审稿专家、突出贡献团队评选结果揭晓</a>
					<span class="time">[2020-01-08]</span>
				</dd>
				</div>
			</dl>
