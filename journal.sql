...
-- Records of acate
-- ----------------------------
INSERT INTO `acate` VALUES (1, '自然科学', NULL, 0, 0);
...
-- Records of article
-- ----------------------------
INSERT INTO `article` VALUES (34, '测试文章204', '1245-2356(2020)2-0-5', 48, '李斯', 1, '测试', '测试文章204摘要', '[参考文献1],[参考文献2],[参考文献3],[参考文献4]', 'N', 'E', 26, 5, 2, 2, 5, 0, 0, 1, 1587626000, 1587614230, 1587625968);
INSERT INTO `article` VALUES (35, '测试文章200', '1245-2356(2020)1-5-6', 48, '李斯', 1, '测试', '测试文章200摘要', '[参考文献1],[参考文献2],[参考文献3],[参考文献4],[参考文献5],', 'N', 'E', 23, 5, 2, 1, 6, 2, 7, 1, 1587625996, 1587614318, 1587614318);
INSERT INTO `article` VALUES (41, '测试文章205', '1245-2356(2020)3-22-8', 48, '李斯', 1, '测试', '测试文章205摘要测试文章205摘要测试文章205摘要d', '[参考文献],[参考文献],[参考文献],[参考文献],[参考文献],[参考文献],', 'N', 'E', 27, 5, 2, 3, 8, 10, 4, 1, 1587708706, 1587624712, 1587708674);
...
-- ----------------------------
INSERT INTO `auth_group` VALUES (1, '主编', '7,9,10,11,151,17,153,19,121,122,128,130,131,132,157,135,136,137,138,139,140,156,158,141,154,143,144,145,146,155,147,148,149,168,169,170,171,172');
...
INSERT INTO `auth_group` VALUES (13, '管理员', '7,9,10,11,151,8,160,164,163,162,161,12,14,15,16,152,123,124,125,126,127,17,153,19,121,122,128,130,131,132,133,134,157,135,136,137,138,139,140,156,158,141,154,143,144,145,146,155,147,148,149,168,169,170,171,172');
...
CREATE TABLE `auth_rule`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 173 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Fixed;
...
INSERT INTO `draft` VALUES (27, 48, '测试稿件205', '/uploads/draft/测试稿件205-詹德秋.doc', NULL, 1, 0, 1, 53, '', 1, 1, 1, 1587708706, 1587459684, 1587459684);
INSERT INTO `draft` VALUES (28, 48, 'fdsa', '/uploads/draft/fdsa-詹德秋.doc', NULL, 1, 0, 1, 52, '', 1, 1, 1, 1587886379, 1587530299, 1587530299);
...
-- Records of journal
-- ----------------------------
INSERT INTO `journal` VALUES (5, '派斯学院学报', 39, '派斯学院学报', '/uploads/fengmian/20200415\\37f04b291f2b2dffbe01003d68df86b8.jpg', '月刊', '1245-2356', '1543/TD', 123, '', 1586930018, 1586930018);
...
-- Records of news
-- ----------------------------
INSERT INTO `news` VALUES (1, '动态1', '<p>新一期投稿通告：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p><p>&nbsp;请在2020年4月10日前完成本期投稿</p>', 1586784747, 1586858143);
INSERT INTO `news` VALUES (2, '动态2', '<p>&nbsp;&nbsp;&nbsp;&nbsp;近期将开展期刊建设会议&nbsp;&nbsp;&nbsp;&nbsp;</p><p>由编辑组人员开会商讨进一步加强期刊建设方案。</p>', 1586784747, 1586784803);
INSERT INTO `news` VALUES (12, '动态3', '<p style=\"text-align: center;\">关于投稿须知条款更改：</p><ol class=\" list-paddingleft-2\" style=\"list-style-type: decimal;\"><li><p>投稿须在本期截止日前进行</p></li><li><p>投稿需以pdf\\wps\\doc文件投递</p></li><li><p>如未及时支付稿费请联系我们</p></li></ol>', 1586784747, 1586784789);
INSERT INTO `news` VALUES (9, '动态4', '<p>&nbsp;&nbsp;&nbsp;&nbsp;今日起截至2020年4月20日，&nbsp;&nbsp;&nbsp;&nbsp;</p><p>开始征集关于“我劳动我光荣”主题文章，&nbsp;&nbsp;&nbsp;&nbsp;</p><p>请广大作者们积极投稿</p>', 1586784747, 1586784813);
INSERT INTO `news` VALUES (7, '动态5', '<p>&nbsp; &nbsp; &nbsp; 为倡导劳动光荣，我们将举行劳动节写作大赛，获得名次有丰厚奖品，大家快快快参与bb</p>', 1586784747, 1586784776);
INSERT INTO `news` VALUES (14, '动态6', '<p>测试公告测试公告测试公告测试公告测试公告测试公告测试公告</p><p>测试公告测试公告</p><p><br/></p>', 1586784837, 1586784837);
...
INSERT INTO `notice` VALUES (14, '测试公告', '<p>测试公告测试公告测试公告测试公告测试公告测试公告测试公告</p><p>测试公告测试公告</p><p><br/></p>', 1586784837, 1586784837);
INSERT INTO `notice` VALUES (15, '测试公告', '<p>测试公告测试公告测试公告测试公告测试公告</p><p>测试公告测试公告测试公告测试公告</p><p>测试公告测试公告测试公告测试公告测试公告</p><p>测试公告测试公告测试公告测试公告</p><p>测试公告测试公告测试公告测试公告测试公告</p>', 1587291526, 1587291526);
